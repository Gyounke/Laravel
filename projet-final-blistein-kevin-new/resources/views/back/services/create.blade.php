                        ...
                        <form action='{{ route('services.store') }}' method='post'>
                            ...
                            <td> 
                                <div class="d-flex">
                                    ...
                                    <label for="icon"><img src="{{ "assets/images/" . $service[0]->icon }}" alt=""></label>
                                  </div>
                                  <div class="d-flex">
                                    <input type="radio" id="huey" name="icon" value="{{ $service[1]->icon }}">
                                    <label for="icon"><img src="{{ "assets/images/" . $service[1]->icon }}" alt=""></label>
                                  </div>
                                  <div class="d-flex">
                                    <input type="radio" id="huey" name="icon" value="{{ $service[2]->icon }}">
                                    <label for="icon"><img src="{{ "assets/images/" . $service[2]->icon }}" alt=""></label>
                                  </div>
                                  <div class="d-flex">
                                    <input type="radio" id="huey" name="icon" value="{{ $service[3]->icon }}">
                                    <label for="icon"><img src="{{ "assets/images/" . $service[3]->icon }}" alt=""></label>
                                  </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <label for="icon"><img src="{{ "assets/images/" . $item->icon }}" alt=""></label>
                                  </div>
                                @endforeach</td> --}}
