                     ...
                     {{-- read_td_anchor --}}
                        <form action='{{ route('services.update' , $service->id) }}' method='post'>
                            ...
                            <td> <div class="d-flex">
                                ...
                                <label for="icon"><img src="{{ "assets/images/" . $services[0]->icon }}" alt=""></label>
                              </div>
                              <div class="d-flex">
                                <input type="radio" id="huey" name="icon" value="{{ $services[1]->icon }}">
                                <label for="icon"><img src="{{ "assets/images/" . $services[1]->icon }}" alt=""></label>
                              </div>
                              <div class="d-flex">
                                <input type="radio" id="huey" name="icon" value="{{ $services[2]->icon }}">
                                <label for="icon"><img src="{{ "assets/images/" . $services[2]->icon }}" alt=""></label>
                              </div>
                              <div class="d-flex">
                                <input type="radio" id="huey" name="icon" value="{{ $services[3]->icon }}">
                                <label for="icon"><img src="{{ "assets/images/" . $services[3]->icon }}" alt=""></label>
                              </div></td>
