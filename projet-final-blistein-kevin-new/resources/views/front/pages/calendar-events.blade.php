							...
							<div class="col-md-12">
								...
								<div class="page-list">
									<ul>
										...
										<li><a href=""{{ url('/front/pages/courses-grid') }}"">Courses Categories</a></li>
									</ul>
								</div>
							</div>	
						</div>
							...
							<div class="col-md-12">
								...
								<div class="calendar-posts">
									<ul>
										...
										<li><span>03</span></li>
										<li><span>04</span></li>
										<li class="calendar-1"><a href="{{ url('/front/pages/single-event') }}"><span>05</span></a></li>
										<li><span>06</span></li>
										<li class="calendar-2"><a href="{{ url('/front/pages/single-event') }}"><span>07</span></a></li>
										<li><span>08</span></li>
										<li class="calendar-3"><a href="{{ url('/front/pages/single-event') }}"><span>09</span></a></li>
										<li><span>10</span></li>
										<li><span>11</span></li>
										<li><span>12</span></li>
										<li><span>13</span></li>
										...
										<li><span>16</span></li>
										<li><span>17</span></li>
										<li class="calendar-4"><a href="{{ url('/front/pages/single-event') }}"><span>18</span></a></li>
										<li><span>19</span></li>
										<li><span>20</span></li>
										<li><span>21</span></li>
										<li><span>22</span></li>
										...
										<li><span>25</span></li>
										<li><span>26</span></li>
										<li class="calendar-5"><a href="{{ url('/front/pages/single-event') }}"><span>27</span></a></li>
										<li class="calendar-6"><a href="{{ url('/front/pages/single-event') }}"><span>28</span></a></li>
										<li class="calendar-7"><a href="{{ url('/front/pages/single-event') }}"><span>29</span></a></li>
										<li><span>30</span></li>
										<li><span>31</span></li>
										<li class="next-month"><span>1</span></li>
										<li class="next-month"><span>2</span></li>
										<li class="next-month"><span>3</span></li>
										<li class="next-month"><span>4</span></li>
									</ul>
								</div>
							</div>
						</div>
