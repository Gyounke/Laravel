							...
							<div class="col-md-12">
								...
								<div class="page-list">
									<ul>
										...
										<li><i class="fa fa-angle-right"></i></li>
										<li><a href="gallery-4.html">Gallery</a></li>
									</ul>
								</div>
							</div>	
						</div>
				...
				<section class="gallery-four">
					<div class="container">
						<div id="projects-filter">
							...
							<a href="#" data-filter=".school">School</a>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row" id="portfolio-grid">
									<div class="item col-md-3 col-sm-6 col-xs-12 classromms">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
											</div>
										</div>
										<div class="down-content">
											<a href="single-teacher.html"><h4>University Gallery</h4></a>
											<span>Classrooms</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 students">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>graduated student</h4></a>
											<span>Students</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 school students">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>kids for glob</h4></a>
											<span>School, Students</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 students classrooms">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>talking in groups</h4></a>
								    ...
								    <div class="item col-md-3 col-sm-6 col-xs-12 students">
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>intelegent kids</h4></a>
											<span>Students</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 office students">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>groups of students</h4></a>
											<span>Office, Students</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 classrooms">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>preparing exam</h4></a>
											<span>Classrooms</span>
										</div>
								    </div>
								    <div class="item col-md-3 col-sm-6 col-xs-12 office">
										<div class="thumb-holder">
											<img src="http://placehold.it/370x240" alt="">
											<div class="hover-content">
												<a href="#light-box"><i class="fa fa-search"></i></a>
										...
										<div class="down-content">
											<a href="single-teacher.html"><h4>geography class</h4></a>
											<span>Office</span>
										</div>
								    </div>
								</div>
				    			...
				    			<form>
							        <div class="lightbox-target" id="goofy">
									 	<div class="gallery-slider">
											<ul class="slides">
											    <li><img src="http://placehold.it/770x410" alt=""></li>
											    <li><img src="http://placehold.it/770x410" alt=""></li>
											    <li><img src="http://placehold.it/770x410" alt=""></li>
											</ul>
										</div>
									   <a class="lightbox-close" href="#"></a>
									   <h4>Graduated Student</h4>
									   <img src="assets/images/line-dec.png" alt="">
									   <p>Wayfarers deep v selfies ethical. Keytar selvage mustache paleo, authentic letterpress you probably haven't heard of them beard normcore aesthetic before they sold out american apparel fashion axe banh mi whatever forage squid.<br><br>Shoreditch ennui post-ironic quinoa 90's blue bottle direct trade you probably haven't heard of them. Banh mi stumptown four loko, Godard biodiesel fap 90's actually wes anderson four dollar toast craft beer direct trade. Chillwave kitsch drinking vinegar, roof party mlkshk asymmetrical Etsy.</p>
									   <div class="row">
									    	<div class="col-md-5">
										    ...
										    <div class="col-md-7 left-images">
										    	<img src="http://placehold.it/225x270" alt="">
										    	<img src="http://placehold.it/225x270" alt="">
										    </div>
									    </div>
									</div>
